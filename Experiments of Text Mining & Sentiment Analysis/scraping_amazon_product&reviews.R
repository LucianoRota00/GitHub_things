...
setwd("G:/.shortcut-targets-by-id/1pilG_gXFMian7SV7bjpBYnTPMGAgQ4zO/Assignment Text Mining") ## Chiara
setwd("G:/Il mio Drive/Assignment Text Mining") ## Andrea
setwd("G:\\.shortcut-targets-by-id\\1pilG_gXFMian7SV7bjpBYnTPMGAgQ4zO\\Assignment Text Mining") ##Luciano
